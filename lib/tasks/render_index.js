...
module.exports = function renderIndex(page, callback) {
  ...
  let cmd = "/opt/paper/create_index.py",
      args = [
        "-s", page.atlas.paper_size,
        "-l", page.atlas.layout,
        "-o", page.atlas.orientation,
        "-b", page.north, page.west, page.south, page.east,
        "-e", page.atlas.north, page.atlas.west, page.atlas.south, page.atlas.east,
        "-z", page.zoom,
  ...
  let upload = S3.upload({
    ...
    Key: "tmp/whatever-index.pdf",
    ACL: "public-read",
    Body: child.stdout,
    CacheControl: "public,max-age=31536000",
    ContentType: "application/pdf"
  }, function(err, data) {
    // TODO there is a race between this and the process ending
    if (err) {
